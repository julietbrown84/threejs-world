...
function addLights() {
  ...
  cylinder.position.set(-2.2, -0.3, 0);
  ...
  rightCylinder.position.set(2, -0.3, 0.3);
...
// loader.load( 'brain.json', function ( geometry, materials ) {
...
//     head.add(leftEye);
    ...
    // var geometry = new THREE.Geometry();
    // geometry.vertices.push(new THREE.Vector3(-10, 0, 0));
    // geometry.vertices.push(new THREE.Vector3(80, 0, -80, 10));
    // geometry.vertices.push(new THREE.Vector3(10, 0, 0));
...
class Cloud {
  ...
  drawParts() {
    ...
    this.leftPart.position.set(-3.7, -0.3, 0);
